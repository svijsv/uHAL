/*
 * This font is derived from font8x8_basic.h found at https://github.com/dhepper/font8x8
 * It's been modified to list the bits in columns instead of rows and in a
 * 1-dimensional array instead of 2-dimensional, and to remove unused glyphs,
 * but otherwise is unaltered
*/

const uint8_t ssd1306_font8x8_basic[] = {
	 0xFF, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0xFF ,  // 0x00 (out-of-bounds glyph)
