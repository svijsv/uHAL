//
// Generated by tools/cmsis/uart_find_periph.sh on Mon Nov 25 03:58:32 PM EST 2024
//
...
# if uHAL_USE_UART_COMM && !defined(UART_COMM_IRQn) && IS_UART1(UART_COMM_RX_PIN, UART_COMM_TX_PIN)
...
# if uHAL_USE_UART_COMM && !defined(UART_COMM_IRQn) && IS_UART2(UART_COMM_RX_PIN, UART_COMM_TX_PIN)
...
# if uHAL_USE_UART_COMM && !defined(UART_COMM_IRQn) && IS_UART3(UART_COMM_RX_PIN, UART_COMM_TX_PIN)
...
# if uHAL_USE_UART_COMM && !defined(UART_COMM_IRQn) && IS_UART6(UART_COMM_RX_PIN, UART_COMM_TX_PIN)
...
# if uHAL_USE_UART_COMM && !defined(UART_COMM_IRQn) && IS_UART4(UART_COMM_RX_PIN, UART_COMM_TX_PIN)
...
# if uHAL_USE_UART_COMM && !defined(UART_COMM_IRQn) && IS_UART5(UART_COMM_RX_PIN, UART_COMM_TX_PIN)
...
# if uHAL_USE_UART_COMM && !defined(UART_COMM_IRQn) && IS_UART7(UART_COMM_RX_PIN, UART_COMM_TX_PIN)
...
# if uHAL_USE_UART_COMM && !defined(UART_COMM_IRQn) && IS_UART8(UART_COMM_RX_PIN, UART_COMM_TX_PIN)
