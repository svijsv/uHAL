//
// Generated by tools/cmsis/spi_find_periph.sh on Sun Sep  1 06:42:13 PM EDT 2024
//
...
# if IS_SPI1(SPI_MOSI_PIN, SPI_MISO_PIN, SPI_SCK_PIN)
#  define SPIx SPI1
...
# if IS_SPI2(SPI_MOSI_PIN, SPI_MISO_PIN, SPI_SCK_PIN)
#  define SPIx SPI2
...
# if IS_SPI3(SPI_MOSI_PIN, SPI_MISO_PIN, SPI_SCK_PIN)
#  define SPIx SPI3
...
# if IS_SPI4(SPI_MOSI_PIN, SPI_MISO_PIN, SPI_SCK_PIN)
#  define SPIx SPI4
...
# if IS_SPI5(SPI_MOSI_PIN, SPI_MISO_PIN, SPI_SCK_PIN)
#  define SPIx SPI5
...
# if IS_SPI6(SPI_MOSI_PIN, SPI_MISO_PIN, SPI_SCK_PIN)
#  define SPIx SPI6
